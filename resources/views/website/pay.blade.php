...
<h2 style="text-align: center">مزرعة العطار</h2>
<p style="text-align: center">اليات الدفع الموجودة في مزرعة العطار هي عبر تعبئة الفورم التالي</p>
<div class="row">
  <div class="col-75">
    <div class="container">
      <form action="{{route('thankyou')}}">
