...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.agriculturalProject.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.agricultural-projects.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nationalid') ? 'is-invalid' : '' }}" type="text" name="nationalid" id="nationalid" value="{{ old('nationalid', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('land_area') ? 'is-invalid' : '' }}" type="number" name="land_area" id="land_area" value="{{ old('land_area', '') }}" step="1" required>
