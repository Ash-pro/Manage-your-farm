...
class GlobalSearchController extends Controller
{
    private $models = [
        ...
        'ProductTag'          => 'cruds.productTag.title',
        'Product'             => 'cruds.product.title',
        'Gallery'             => 'cruds.gallery.title',
        'RequestAService'     => 'cruds.requestAService.title',
        'AgriculturalProject' => 'cruds.agriculturalProject.title',
        'CommonDisease'       => 'cruds.commonDisease.title',
        'AskConsultation'     => 'cruds.askConsultation.title',
    ];
